...
//自定义校验规则
 $.validator.addMethod(
	...
	function(value,element,params){
		...
		$.ajax({
			"async":false,//是否多线程异步？ false表示单线程，不异步，异步的话 无法判断flag先在哪个线程赋值
			...
			<div class="col-md-8"
				...
				<form  id="registerForm"class="form-horizontal" style="margin-top: 5px;" action="${pageContext.request.contextPath }/register" method="post">
					...
					<div class="form-group">
						...
						<label for="repassword" generated="true" class="error" style="display:none"></label>
					</div>
					<div class="form-group">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							<label class="radio-inline"> <input type="radio"
								...
								<label for="sex" generated="true" class="error" style="display:none"></label>
						</div>
					</div>
					<div class="form-group">
