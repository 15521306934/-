		...
		<table width="100%" height="70%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="200px" height="140px">
					<img  src="${pageContext.request.contextPath}/images/tubiao.png">
				</td>

				<td width="1100px" height="160px" background="${pageContext.request.contextPath}/images/pbrmgr.png">
				</td>
			</tr>
		</table>
