...
<script type="text/javascript">
			function deleteCategory(cid){
				if(confirm("确认删除吗？")){
					//确认删除
				location.href="${pageContext.request.contextPath}/admin?method=deleteCategory&cid="+cid;
				};
			}
				...
				<td class="ta_01" align="center" bgColor="#f5fafe">
					...
					<c:forEach items="${categoryList }" var="category">
							...
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<a
									href="${pageContext.request.contextPath }/editForwordCid?cid=${category.cid}&cname=${category.cname}">
										<img
