...
<script type="text/javascript">
	function addCart(){
		...
		//
		location.href="${pageContext.request.contextPath}/addProductToCart?pid=${productInfo.pid}&buyNumber="+buyNumber;
	}
</script>
</head>
					...
					<div
						...
						<div style="margin: 5px 0 10px 0;">白色</div>
 						...
 						<div style="border-bottom: 1px solid #faeac7; margin-top: 20px; padding-left: 10px;">
							购买数量: <input id="buyNumber" name="buyNumber" value="1" maxlength="4" size="10" type="text">
						</div>
						...
						<div>
							&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="${pageContext.request.contextPath}/findProductById?cid=${cid }&currentPage=${currentPage}">返回上一页</a>
						</div>
			</div>
			<div class="clear"></div>
