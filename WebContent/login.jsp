		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<div>&nbsp;</div>
					<form action="${pageContext.request.contextPath }/loging" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div style="color:red;text-align:center">${checkInfo } </div>
						<div class="form-group">
